...
/**
 * Derived from vaadin SQLContainer
 * @author delabre
 *
 */
public class ODBContainer implements Container, Container.Filterable,
        Container.Indexed, Container.Sortable, Container.ItemSetChangeNotifier {

    /** Generated serial id */
	private static final long serialVersionUID = -4219725434168972557L;
    ...
    /** List of references to other ODBContainers */
    private final Map<ODBContainer, Reference> references = new HashMap<ODBContainer, Reference>();
     ...
     */
    protected ODBContainer() {
    }

    /**
     * Creates and initializes ODBContainer using the given QueryDelegate
     * 
     * @param delegate
     *            QueryDelegate implementation
     * @throws OException
     */
    public ODBContainer(QueryDelegate delegate) throws OException {
        if (delegate == null) {
        ...
        try {
            ...
            for (RowItem item : removedItems.values()) {
                if (!delegate.removeRow(item)) {
                    throw new OException("Removal failed for row with ID: "
                            + item.getId());
                }
            }
     ...
     * @throws OException
     */
    private void getPropertyIds() throws OException {
        propertyIds.clear();
        propertyTypes.clear();
    ...
    protected void fireContentsChange() {
        if (itemSetChangeListeners != null) {
            ...
            final Container.ItemSetChangeEvent event = new ODBContainer.ItemSetChangeEvent(
                    this);
    ...
    public static class ItemSetChangeEvent extends EventObject implements
        ...
        private ItemSetChangeEvent(ODBContainer source) {
            super(source);
        }
     ...
     *            referenced key
     */
    public void addReference(ODBContainer refdCont, String refingCol,
            String refdCol) {
        if (refdCont == null) {
            throw new IllegalArgumentException(
     ...
     */
    public boolean removeReference(ODBContainer refdCont) {
        if (refdCont == null) {
            throw new IllegalArgumentException(
                    "Referenced SQLContainer can not be null.");
        }
     ...
     */
    public Object getReferencedItemId(Object itemId, ODBContainer refdCont) {
        if (refdCont == null) {
            throw new IllegalArgumentException(
                    "Referenced SQLContainer can not be null.");
        }
     ...
     */
    public Item getReferencedItem(Object itemId, ODBContainer refdCont) {
    ...
    private static final Logger getLogger() {
        return Logger.getLogger(ODBContainer.class.getName());
    }
